...
<div class="wrapper">
        ...
        <div class="content"><div style="padding-left: 20px;padding-right: 20px">
             <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label>所选套系(请输入套系编号后两位)</label>
                                                <input type="text" class="form-control border-input"  placeholder="Your TaoXi" value="${userInfo[0].uteach}" id="uteach">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
	...
	function update(){
			...
			var uteach = document.getElementById("uteach").value;
			if(account==""||name==""||pwd==""||age==""||sex==""||tel==""||address==""||uteach==""){
