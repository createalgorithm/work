                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>婚纱套系名称</label><input type="hidden"value="${upTeachList[0]}" id="id">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select type="text" class="form-control border-input" placeholder="Your Phone"  id="cid">
                                                	<option value="1" <c:if test="${upTeachList[2]==1}">selected = "selected"</c:if>>合照</option>
                                                	<option value="2" <c:if test="${upTeachList[2]==2}">selected = "selected"</c:if>>单人照</option>
                                                	<option value="3" <c:if test="${upTeachList[2]==2}">selected = "selected"</c:if>>海边写真</option>
                                                	<option value="4" <c:if test="${upTeachList[2]==2}">selected = "selected"</c:if>>穿越时空</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
