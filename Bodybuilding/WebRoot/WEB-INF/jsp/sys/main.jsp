...
<body style="background:url(../images/login.png) no-repeat center 0">
...
<div class="wrapper">
    ...
    <div class="main-panel" style="background:url(../images/login.png) no-repeat center 0" >
                        ...
                        <div class="card">
                            <div class="content">
                                ...
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                      <a href="userTable"><i class="ti-reload"></i> Updated now</a> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="content">
                                ...
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <a href="teachTable"> <i class="ti-reload"></i> Updated now</a> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="content">
                                ...
                                <div class="footer">
                                    <hr />
                                    <div class="stats">
                                        <a href="apparatusTable"> <i class="ti-reload"></i> Updated now</a> 
                                    </div>
                                </div>
                            </div>
                        </div>
