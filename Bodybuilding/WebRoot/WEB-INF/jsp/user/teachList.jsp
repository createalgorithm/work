		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">摄影师列表</a>
                </div>
                <div class="collapse navbar-collapse">
                  <marquee>恭喜我们的爱丽丝摄影师为陈慕白拍摄的“情定巴厘岛”获得好评。</marquee>
                </div>
            </div>
        </nav>
...
<c:forEach var="list" items="${SelectTeachInfo}">
	...
	function select(id,cid,uid){
		var s = "<%=session.getAttribute("userId")%>";
		var uid = s;
		
		layer.confirm('确认要选择这位摄影师吗？',function(index){
			$.ajax({
				type: 'get',
				url: 'chooseTeach',
				data: {id : id,
				...
				success: function(data){
					layer.msg('选择成功，请按时进行拍摄!',{icon: 1,time:2000});
					setTimeout(function(){
