		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">选择列表</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">摄影师列表</h4><input type="hidden" value="${SelectTeachInfo}" id="SelectTeachInfo">
                                <p class="category">请选择你需要的摄影师</p>
                            </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <c:forEach var="list" items="${classInfo}">
                                        <tr>
                                        	<td>${list.id}</td>
                                        	<td>${list.cname}</td>
                                        	<td><button class="btn btn-primary btn-fill " onclick="select(${list.id})">选择摄影师</button></td> 
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
...
function selectTeach(){
	...
	if(SelectTeach==""){
		layer.msg('请先选择摄影师!',{icon: 2,time:2000});
	}
	if(SelectTeach!=""){
		window.location.href='teachList';
	}
