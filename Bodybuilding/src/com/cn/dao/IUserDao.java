...
public interface IUserDao {
	...
	void chooseTeach(@Param("id")  Integer id, @Param("cid") Integer cid,@Param("uid") Integer uid);

	void updateUserInfo(@Param("id")Integer id,@Param("account")String account, @Param("sex")Integer sex,@Param("age") Integer age,@Param("name") String name,@Param("pwd") String pwd,@Param("tel") String tel, @Param("address")String address, @Param("uteach")Integer uteach);
