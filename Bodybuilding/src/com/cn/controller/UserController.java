...
public class UserController {
    ...
    public String updateUserInfo(Integer id,String account,Integer sex,Integer age,String name,String pwd,String tel,String address,Integer uteach){  
    	userService.updateUserInfo(id,account,sex,age,name,pwd,tel,address,uteach);
    	return "true";
    }  
    ...
    public String accountDetail(String account){
